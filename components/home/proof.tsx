...
/**
 * Omitted entirely by the data layer until there is real proof to show —
 * never a hollow section, and never a fabricated quote or metric.
 */
  ...
  return (
    <Section>
      <Container width="narrow">
        <Eyebrow className="mb-8">Proof</Eyebrow>
